...
// TODO: Re-enable these once we fix Supabase integration
// import { supabaseTrips } from '../services/supabaseTrips'

// TODO: Re-enable once we implement Supabase sync properly
...
export function TripProvider({ children }: { children: ReactNode }) {
  ...
  const createTrip = (tripData: Omit<Trip, 'id' | 'created_by' | 'created_date' | 'updated_date'>): string => {
    ...
    // TODO: Re-enable Supabase sync once we fix the database schema
    // For now, localStorage only to ensure app works
